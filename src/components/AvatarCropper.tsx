                ...
                <div className="px-6 py-3 bg-muted border-b border-border shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className="p-1.5 bg-card border border-border text-text-secondary rounded-lg hover:bg-muted transition-colors"
                        >
                        ...
                        <input
                            ...
                            className="flex-1 h-2 bg-border rounded-lg appearance-none cursor-pointer accent-blue-600"
                        />
                        <button
                        ...
                        <button
                            ...
                            className="px-2 py-1.5 bg-card border border-border text-text-secondary rounded-lg hover:bg-muted transition-colors text-xs font-medium shrink-0"
                        >
                            {t('fit')}
                        </button>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="flex-1 px-3 py-2 bg-card border border-border text-text-secondary rounded-lg hover:bg-muted transition-colors text-sm font-medium flex items-center justify-center gap-2"
                            >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                                ...
                                className="px-3 py-2 bg-card border border-border text-text-secondary rounded-lg hover:bg-muted transition-colors text-sm font-medium"
                            >
                                {t('reset')}
                            </button>
                            <button
                ...
                <div className="p-6">
                    <div className="flex gap-3">
                        <button
                            onClick={onCancel}
                            disabled={loading}
                            className="flex-1 px-4 py-2.5 border border-border text-text-secondary rounded-lg hover:bg-muted transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {t('cancel')}
                        </button>
                        <button
